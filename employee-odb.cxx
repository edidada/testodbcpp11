...
namespace odb
{
  ...
  const char access::object_traits_impl< ::employee, id_mysql >::emails_traits::
  select_statement[] =
  "SELECT "
  "`employee_emails`.`value` "
  "FROM `employee_emails` "
  "WHERE `employee_emails`.`object_id`=?";
  ...
  void access::object_traits_impl< ::employee, id_mysql >::emails_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::employee, id_mysql >::emails_traits::
  ...
  struct access::object_traits_impl< ::pension_fund, id_mysql >::extra_statement_cache_type
  {
    mysql::container_statements_impl< members_traits > members_;
  ...
  const char access::object_traits_impl< ::pension_fund, id_mysql >::members_traits::
  select_statement[] =
  "SELECT "
  "`pension_fund_members`.`index`, "
  "`pension_fund_members`.`value` "
  "FROM `pension_fund_members` "
  "WHERE `pension_fund_members`.`object_id`=? ORDER BY `pension_fund_members`.`index`";
  ...
  void access::object_traits_impl< ::pension_fund, id_mysql >::members_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::pension_fund, id_mysql >::members_traits::
  ...
  access::object_traits_impl< ::pension_fund, id_mysql >::id_type
  access::object_traits_impl< ::pension_fund, id_mysql >::
  id (const image_type& i)
  {
    mysql::database* db (0);
    ODB_POTENTIALLY_UNUSED (db);
  ...
  bool access::object_traits_impl< ::pension_fund, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
    ODB_POTENTIALLY_UNUSED (i);
  ...
  void access::object_traits_impl< ::pension_fund, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        mysql::statement_kind sk)
  {
  ...
  const char access::object_traits_impl< ::pension_fund, id_mysql >::persist_statement[] =
  "INSERT INTO `pension_fund` "
  "(`name`) "
  "VALUES "
  "(?)";

  const char access::object_traits_impl< ::pension_fund, id_mysql >::find_statement[] =
  "SELECT "
  "`pension_fund`.`name` "
  "FROM `pension_fund` "
  "WHERE `pension_fund`.`name`=?";

  const char access::object_traits_impl< ::pension_fund, id_mysql >::erase_statement[] =
  "DELETE FROM `pension_fund` "
  "WHERE `name`=?";

  const char access::object_traits_impl< ::pension_fund, id_mysql >::query_statement[] =
  "SELECT "
  "`pension_fund`.`name` "
  "FROM `pension_fund`";

  const char access::object_traits_impl< ::pension_fund, id_mysql >::erase_query_statement[] =
  "DELETE FROM `pension_fund`";

  const char access::object_traits_impl< ::pension_fund, id_mysql >::table_name[] =
  "`pension_fund`";
  ...
  access::object_traits_impl< ::pension_fund, id_mysql >::pointer_type
  access::object_traits_impl< ::pension_fund, id_mysql >::
  find (database& db, const id_type& id)
  {
    using namespace mysql;
  ...
  result< access::object_traits_impl< ::pension_fund, id_mysql >::object_type >
  access::object_traits_impl< ::pension_fund, id_mysql >::
  query (database&, const query_base_type& q)
  {
    using namespace mysql;
  ...
  unsigned long long access::object_traits_impl< ::pension_fund, id_mysql >::
  erase_query (database&, const query_base_type& q)
  {
    using namespace mysql;
